...
public:
    ...
    void draw(SDL_Renderer *renderer, SDL_Texture *line, int scale, int ox, int oy, int r, int g, int b) const;

    void drawEdges(SDL_Renderer *renderer, SDL_Texture *line, int scale, int ox, int oy) const;
